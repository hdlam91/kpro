...
Our implementation followed the the clean code principle and template written on \ref{cCoding} Templates and Standards on page \pageref{cCoding}. This ensured that the code followed the standard and was readable for other developers. All the methods we implemented had XML Style Comment for documentation purposes. \\
