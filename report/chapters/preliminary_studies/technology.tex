...
Visual Studio is Microsoft's IDE for development for their platforms. This is the main IDE we developed the framework on, seeing as it has very good integration with C\# and .NET platforms, which we were required to use. We decided to use the \emph{Ultimate} version because this version provides everything we might need.
