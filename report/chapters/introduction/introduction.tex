...
Webassistenten will require certain data along with the pdf, such as date, module etc. These data will be saved into a database internally in their system. % Rewrite? What kind of "date" and "module"?
...
Jostein Danielsen - \href{mailto://josetein.danielsen@adresseavisen.no}{josetein.danielsen@adresseavisen.no}\\ %Jostein or Josetein - or both?
\\
