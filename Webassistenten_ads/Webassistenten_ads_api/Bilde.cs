...
namespace Webassistenten_ads_api
{
    ...
    public partial class Bilde
    {
        public Bilde()
        {
            this.BestillingHarBildes = new HashSet<BestillingHarBilde>();
        }
        ...
        public virtual ICollection<BestillingHarBilde> BestillingHarBildes { get; set; }
    }
}
